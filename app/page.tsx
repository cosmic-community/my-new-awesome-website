...
export default async function Page() {
  ...
  // Fallback hero image if none is provided
  const heroImageUrl = hero_image?.imgix_url 
    ? `${hero_image.imgix_url}?w=2400&h=600&fit=crop&auto=format,compress`
    : "https://images.unsplash.com/photo-1486312338219-ce68e2c6b1e6?w=2400&h=600&fit=crop&auto=format,compress"

  return (
    <div className="text-center py-20 px-4">
      <h1 className="text-4xl font-bold mb-6">{title || 'Welcome to My Awesome Website'}</h1>
      <img 
        src={heroImageUrl} 
      ...
      />
      <p className="text-lg my-6 max-w-2xl mx-auto">
        {description || 'This is a beautiful landing page built with Next.js and Cosmic CMS. Add content to your Landing Page object in Cosmic to customize this page.'}
      </p>
      <button className="mt-6 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
